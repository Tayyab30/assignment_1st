...
var arr: string[] = [ "Islamabad", "Ahmed Nager", "Ahmadpur East", "Ali Khan", "Alipur", "Arifwala", "Attock"];

function changeArray(arr:string[], index:number, value:string ) {
  arr.splice(index, 0, value);
  return arr
}
var modified_array:string[] = changeArray(arr, 2, "Faisalabad");
...
function addItem(index: number, value: MyObject) {
...
var singleValue2: MyObject= { name: "TV", price: 19.99, quantity: 2 };
...
var arry_of_numbers: number[] = [1, 2, 4, -3, 6, -2, 6, -7];
var i = 0;
function removeNegativeNumber(arry_of_numbers:number[]) {
...
var celsius_temperatures:number[] = [25, 30, 15, 10];
var converted_temp_tp_fahrenheit:number[] = [];
var index:number = 0;
